...
import com.example.dinnerdecider.*
import com.example.dinnerdecider.InternetCheck
...
class ChooseCategories : Fragment() {
    ...
    private var categoryList: List<CategoryModel> = listOf(
        CategoryModel("Fast food"), CategoryModel("Mexican"),
        CategoryModel("Chinese"), CategoryModel("Japanese"),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        btnInfo = v.findViewById(R.id.img_info)
